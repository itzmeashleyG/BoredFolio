...
const photos: Photo[] = [
  { src: "/dap.jpg",      alt: "DAP Building — Development Academy of the Philippines" },
  { src: "/dapbuild.jpg", alt: "DAP Building exterior" },
  { src: "/dap2.jpg",     alt: "Rooftop terrace with Makati city skyline" },
  { src: "/id.jpg",       alt: "DAP intern ID cards" },
  { src: "/laptop.jpg",   alt: "Gate Pass Management login page on laptop" },
  { src: "/offics.jpg",   alt: "Working at the DAP office" },
  { src: "/present.jpg",  alt: "Final presentation — Equipment Tracking & Gate Pass Management System" },
];
...
export default function Gallery() {
  ...
  /* Auto-play: slide left every 3 s */
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-[-0.02em] text-neutral-900 dark:text-white mb-10 sm:mb-14 leading-tight">
        <RevealWord text="Moments" className="block" />
        <RevealWord text="captured." className="block text-neutral-400 dark:text-neutral-700" delay={0.18} />
      </h2>
